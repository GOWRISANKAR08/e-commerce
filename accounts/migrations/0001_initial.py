    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reg_no', models.CharField(default=uuid.uuid4, max_length=64, unique=True)),
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Admin'), ('USER', 'User'), ('GUESTUSER', 'Guest User')], default='USER', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address_name', models.CharField(blank=True, max_length=120, null=True)),
                ('address', models.TextField()),
                ('street_flat', models.CharField(blank=True, max_length=255, null=True)),
